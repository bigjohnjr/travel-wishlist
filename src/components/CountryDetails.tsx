    ...
    const countrydetails = details.map((detail) => {
        return (
            ...
            <div className="country-data__main-details">
                <div className="country-data__capital"><span className="strong">Capital:</span> {detail.capital}</div>
                <div className="country-data__region"><span className="strong">Region:</span> {detail.region}</div>
            </div>
            ...
            <ul>
                ...
                <li><span className="strong">Population:</span> {detail.population}</li>
            </ul>
            </div>
        );
    });
